    ...
    <form action="delete_clients.php" method="POST">
        <table>
            ...
            <?php
                ...
                where Nombre LIKE '%{$nombre}%' and Apellido1 LIKE '%{$apellido1}%' and Apellido2 LIKE '%{$apellido2}%' and
                Poblacion LIKE '%{$poblacion}%' and Provincia LIKE '%{$provincia}%' and Telefono LIKE '%{$telefono}%'
                order by Id_Cliente";
